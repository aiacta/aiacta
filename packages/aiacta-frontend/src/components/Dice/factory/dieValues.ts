...
export const dice = {
  ...
  d10: {
    ...
    faces: [
      ...
      { indices: [1, 0, 2], value: -1 },
      { indices: [1, 2, 3], value: -1 },
      { indices: [3, 2, 4], value: -1 },
      { indices: [3, 4, 5], value: -1 },
      { indices: [5, 4, 6], value: -1 },
      { indices: [5, 6, 7], value: -1 },
      { indices: [7, 6, 8], value: -1 },
      { indices: [7, 8, 9], value: -1 },
      { indices: [9, 8, 0], value: -1 },
      { indices: [9, 0, 1], value: -1 },
    ],
    uvTemplate: [
      [
        0.5 + Math.cos(((210 + 0) * Math.PI) / 180) * 0.5,
